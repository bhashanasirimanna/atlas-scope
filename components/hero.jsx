...
export default function Hero() {
  ...
  return (
    <section className="w-full bg-blue-300/20 dark:bg-neutral-950 md:h-[90vh] antialiased relative overflow-hidden pb-5 md:pb-0">
      <div className="container px-4 md:px-6 max-w-[1300px]  mx-auto">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="hidden md:flex flex-col justify-center space-y-4 z-40">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                Discover the World
              </h1>
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                Explore countries, their cultures, and geography with our
          ...
          <div className="md:hidden flex flex-col justify-center space-y-4 z-40">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                Discover the World
              </h1>
